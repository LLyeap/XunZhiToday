...
- (int)busyRetryTimeout {
    ...
    DBLog(@"FMDB: busyRetryTimeout no longer works, please use maxBusyRetryTimeInterval");
    return -1;
}
...
#pragma unused(i)
    DBLog(@"%s:%d", __FUNCTION__, __LINE__);
    DBLog(@"FMDB: setBusyRetryTimeout does nothing, please use setMaxBusyRetryTimeInterval:");
}
